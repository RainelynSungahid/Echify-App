...
class SentenceBuilder:
    ...
    def expand(self, raw: str) -> str:
        ...
        # ── LIKE / LOVE patterns ─────────────────────────────
        if pre in {"I LIKE YOU", "ME LIKE YOU"}:
            return "I like you."

        if pre in {"I LOVE YOU", "ME LOVE YOU"}:
            return "I love you."
        ...
        if pre == "I LIKE FRIEND":
            return "I like my friend."

        if pre == "I LOVE FAMILY":
            return "I love my family."

        if pre == "YOU LIKE FAMILY":
            return "You like your family."

        if pre == "YOU LOVE FAMILY":
            return "You love your family."
